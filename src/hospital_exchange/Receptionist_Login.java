...
public class Receptionist_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Receptionist Login Form");
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
     ...
     String query = "SELECT * FROM receptionist_details WHERE username=? AND password=?";
        ...
        this.dispose();
            ...
            Logger.getLogger(Receptionist_Login.class.getName()).log(Level.SEVERE, null, ex);
        }
